...
(function () {
  ...
  function genMember(id) {
    ...
    return {
      ...
      workEmail: email, status: st, role, accountType: 'silent',
  ...
  const HAND_CRAFTED = [
    {
      id:1, name:'Sarah Mitchell', initials:'SM', avatarColor:'#0168DD',
    ...
    },
    {
      ...
      workEmail:'james.rodriguez@hubstaff.com', status:'active', role:'Manager', accountType:'silent',
    ...
    {
      id:3, name:'Emily Chen', initials:'EC', avatarColor:'#059669',
      ...
      workEmail:'emily.chen@hubstaff.com', status:'active', role:'Member', accountType:'silent',
    ...
    {
      id:4, name:'DavidKim@', initials:'DK', avatarColor:'#D97706',
      ...
      workEmail:'david.kim@hubstaff.corp', status:'active', role:'Member', accountType:'silent',
    ...
    {
      id:5, name:'AmandaFoster@', initials:'AF', avatarColor:'#DC2626',
      ...
      workEmail:'amanda.foster@hubstaff.corp', status:'active', role:'Member', accountType:'standard',
    ...
    {
      id:11, name:'SarahMitchell@', initials:'SM', avatarColor:'#0168DD',
      ...
      workEmail:'sarah.mitchell@hubstaff.corp', status:'active', role:'Member', accountType:'silent',
    ...
    {
      id:12, name:'JamesRodriguez@', initials:'JR', avatarColor:'#7C3AED',
      ...
      employment:{ jobDetails:{ jobTitle:null, jobType:null, department:null }, hiringDetails:{ employmentType:null, workArrangement:null, employedThrough:null, vendorName:null }, accounting:{ taxId:null, taxType:null, accountCode:null, currency:null }, timeline:{ startDate:null, endDate:null, terminationReason:null, comment:null } },
      workEmail:'james.rodriguez@hubstaff.corp', status:'active', role:'Member', accountType:'silent',
      projects:0, workOrders:0, payment:{ payRate:null, billRate:null, frequency:null }, limits:{ weeklyHours:null, dailyHours:null }, screenshots:{ frequency:null, count:0, active:false }, appsAndUrls:{ tracked:false, count:0 }, timeTracking:{ enabled:false, weeklyLimit:null, dailyLimit:null, approvals:false }, dateAdded:'2026-06-01', dateRemoved:null, billing:'unbilled', graceDays:10, mergeSuggestion:true, mergeIntoId:2,
    },
    {
      id:13, name:'EmilyChen@', initials:'EC', avatarColor:'#059669',
      ...
      employment:{ jobDetails:{ jobTitle:null, jobType:null, department:null }, hiringDetails:{ employmentType:null, workArrangement:null, employedThrough:null, vendorName:null }, accounting:{ taxId:null, taxType:null, accountCode:null, currency:null }, timeline:{ startDate:null, endDate:null, terminationReason:null, comment:null } },
      workEmail:'emily.chen@hubstaff.corp', status:'active', role:'Member', accountType:'silent',
      projects:0, workOrders:0, payment:{ payRate:null, billRate:null, frequency:null }, limits:{ weeklyHours:null, dailyHours:null }, screenshots:{ frequency:null, count:0, active:false }, appsAndUrls:{ tracked:false, count:0 }, timeTracking:{ enabled:false, weeklyLimit:null, dailyLimit:null, approvals:false }, dateAdded:'2026-06-01', dateRemoved:null, billing:'unbilled', graceDays:10, mergeSuggestion:true, mergeIntoId:3,
    },
    {
      id:6, name:'Lisa Johnson', initials:'LJ', avatarColor:'#6B7280',
      ...
      workEmail:'lisa.johnson@company.com', status:'inactive', role:'Member', accountType:'standard',
    ...
    {
      id:7, name:'Michael Torres', initials:'MT', avatarColor:'#0891B2',
      ...
      workEmail:'michael.torres@company.com', status:'grace', role:'Member', accountType:'silent',
    ...
    {
      id:8, name:'Robert Smith', initials:'RS', avatarColor:'#7C3AED',
      ...
      workEmail:'robert.smith@company.com', status:'grace', role:'Member', accountType:'silent',
    ...
    },
    {
      ...
      workEmail:'alex.patel@company.com', status:'invited', role:'Member', accountType:'standard',
    ...
    },
    {
      ...
      workEmail:'maria.garcia@company.com', status:'active', role:'Admin', accountType:'sso',
    ...
    },
    {
      ...
      workEmail:'chris.wallace@hubstaff.com', status:'removed', role:'Member', accountType:'standard',
    ...
    },
    {
      ...
      workEmail:'nina.larsen@hubstaff.com', status:'removed', role:'Manager', accountType:'standard',
    ...
    },
    {
      ...
      workEmail:'tom.okafor@hubstaff.com', status:'removed', role:'Member', accountType:'silent',
    ...
    },
    {
      ...
      workEmail:'dana.wright@hubstaff.com', status:'removed', role:'Member', accountType:'standard',
    ...
    },
    {
      ...
      workEmail:'marcus.reeves@hubstaff.com', status:'removed', role:'Viewer', accountType:'standard',
